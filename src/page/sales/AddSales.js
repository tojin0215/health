                ...
                <div className='container'>
                    ...
                    <form className="AddSalesForm productPay" style={{ flexDirection: 'column' }}>
                        ...
                        <div className='finalAmount'>
                            ...
                            <div className='paidMembership1'>
                                <label className='paidMembership2'>
                                    <span>회원권</span>
                                    <input type='number' name='paidMembership' id='paidMembership' onChange={this.handleChange} value={this.state.paidMembership} />회
                                </label>{/*.paidMembership2 */}
                            </div>{/*.paidMembership1 */}
