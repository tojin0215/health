              ...
              <div>
                <label>
                  <input
                    ...
                    value='1'
                    name='join_route'
                    checked={this.state.join_route === '간판' ? true : false}
                    onChange={this.handleChange}
                  />
                  간판
                </label>
                <label>
                  <input
                    ...
                    name='join_route'
                    checked={
                      this.state.join_route === '홈페이지' ? true : false
                    }
                    onChange={this.handleChange}
                  />
                  홈페이지
                ...
                <label>
                  <input
                    ...
                    value='3'
                    name='join_route'
                    checked={this.state.join_route === '전단지' ? true : false}
                    onChange={this.handleChange}
                  />
                  전단지
                </label>
                <label>
                  <input
                    ...
                    name='join_route'
                    checked={
                      this.state.join_route === '지인소개' ? true : false
                    }
                    onChange={this.handleChange}
                  />
                  지인소개
                ...
                <label>
                  <input
                    ...
                    value='5'
                    name='join_route'
                    checked={this.state.join_route === 'SNS' ? true : false}
                    onChange={this.handleChange}
                  />
                  SNS
                </label>
                <label>
                  <input
                    ...
                    value='6'
                    name='join_route'
                    checked={this.state.join_route === '기타' ? true : false}
                    onChange={this.handleChange}
                  />
                  기타
                  <input
                    ...
                    placeholder='기타 가입경로'
                    name='joinexc'
                    defaultValue={this.state.joinRouteEXC}
                    onChange={this.handleChange}
                  />
                </label>
              </div>
